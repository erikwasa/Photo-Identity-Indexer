...
WI-0118 through WI-0120 are the core proof-of-value sequence. WI-0121 through WI-0128 plus WI-0158 and WI-0162 are follow-on product/quality work. They are not an assertion that every experimental feature must ship: a follow-on may conclude with a measured no-go/retirement decision recorded through the normal work-item lifecycle rather than forcing unnecessary implementation.
...
- [WI-0128](../work-items/WI-0128-caption-narration-experiment.md) - evaluate and productize optional local captions/story evidence after the simpler Creative Collection product proves useful.
- [WI-0162](../work-items/WI-0162-semantic-caption-search-slideshow-collections.md) - scale the promising semantic text-to-photo and caption-search paths, including Swedish queries, and save selected search results as explicit slideshow collections.
...
On 2026-09-25 the maintainer accepted WI-0158 after named Creative Collections became first-class slideshow-library entries, with multiple independently named Creative variants allowed per Smart Collection anchor.
