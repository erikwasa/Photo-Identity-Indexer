...
- [ ] Typing a place fragment narrows the reusable vocabulary.
- [ ] Selection stores the same canonical Place path.
- [ ] Photo Details and Smart Collections use the same component.
