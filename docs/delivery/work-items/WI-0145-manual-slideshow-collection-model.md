...
- Verification evidence: PR #407 merged on 2026-09-22 and CI run #2095 completed successfully across build/fast tests, both integration shards, living/generated documentation checks, launcher verification and Windows package verification. The work item's required Core/PostgreSQL/API coverage therefore passed before the WI-0146 UI layer.
- Lifecycle: WI-0145 is complete. End-to-end desktop/phone curation and launch behavior remains owned by WI-0146 rather than reopening the backend collection-model contract.
