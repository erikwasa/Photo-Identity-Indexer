...
depends_on: [WI-0129, WI-0130, WI-0131, WI-0134, WI-0135, WI-0136]
related_adrs: []
...
- Test on the supported iPhone/browser path and at least one desktop browser.
...
- [ ] `/slideshows` supports the intended choose -> tap -> watch path.
