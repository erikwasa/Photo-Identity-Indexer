...
depends_on: [WI-0079, WI-0081]
related_adrs: []
affected_modules: [PhotoIdentity.Web, documentation]
---

# WI-0082: Harden slideshow playback for toddler-safe phone use
...
Protected slideshow is enabled by default and is the primary M21 acceptance mode.
...
- The supported WI-0079 secure phone path should provide the secure context required by current browsers for Wake Lock.
...
Use the real supported phone path from WI-0079 and exercise toddler-like interaction for a representative autoplay session:
