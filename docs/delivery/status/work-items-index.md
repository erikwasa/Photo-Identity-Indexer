...
| [WI-0144](../work-items/WI-0144-smart-collection-multiple-locations.md) Allow Smart Collections to match any of multiple named locations | M28 | in_progress | ai-agent | [YAML](work-items/active/WI-0144.yaml) |
...
| [WI-0157](../work-items/WI-0157-reduced-precision-place-fallback.md) Add reduced-precision place fallback for GPS photos without populated-place matches | M28 | in_progress | ai-agent | [YAML](work-items/active/WI-0157.yaml) |
