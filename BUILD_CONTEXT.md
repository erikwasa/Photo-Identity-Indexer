...
**M28 Library curation and metadata editing continues with WI-0145: explicit photo-list collections for manually assembled slideshows.**
...
WI-0145 is the next planned M28 dependency. WI-0146 follows after the explicit photo-list collection contract is stable. M26 remains active separately. M29 is ready. M30 video support remains intentionally blocked until explicit maintainer reactivation.

## Next concrete step

Implement WI-0145: add explicit ordered photo-list collections for manually assembled slideshows, preserving the distinction between immutable/manual revision lists and Smart Collection query definitions.
