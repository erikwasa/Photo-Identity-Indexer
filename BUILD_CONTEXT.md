...
WI-0110 similar-face discovery and WI-0111 bounded follow-up regeneration are complete. WI-0112 suggested-person grouped review and WI-0113 provisional-cluster model/algorithm evaluation have both passed maintainer verification and remain `in_review` only until their separate one-work-item closeout PRs move them to `completed`.
...
Merge the WI-0111 closeout PR, then close WI-0112 and WI-0113 through separate lifecycle PRs. After WI-0113 is completed, prepare WI-0114 using the selected DBSCAN policy and exact-first neighbour-search decision.

Do not combine the remaining terminal work-item transitions into one PR. Do not add ANN to WI-0114 unless measured production retrieval justifies it.
